...
class UVSpline:
    ...
    Args:
        order: int - the order of the B-splines (default: 4)
            must be at least 2

        interval: list or tuple of length 2 - the interval of definition of the B-splines (default: (0,1))
            must be in the form (a,b) or [a,b] where a < b

        knots: np.ndarray - (optional) the interior knots of the B-splines
    ...
    Properties:
        order: int - the order the B-splines

        interval: tuple - the interval of definition

        knots: np.ndarray - the interior knots of the spline (B-splines)
        ...
        knots_scaled: np.ndarray - the interior knots of the B-splines scaled to lie in the interval (0,1)

        coefficients: np.ndarray - the coefficients of the B-splines that define the Spline
    ...
    def b_splines(self, x):
        ...
        Args:
            x: np.ndarray of shape (n,) the values at which to compute the B-splines
